...
Вот код на языке Julia, который достигает этой цели. Примерно такой код, скорее всего, должен получиться, если следовать технологии проектирования "сверху вниз" (конечно, тут возможны варианты). Полученный код в данном случае состоит из главной функции и 3-х вспомогательных (подпрограмм):
